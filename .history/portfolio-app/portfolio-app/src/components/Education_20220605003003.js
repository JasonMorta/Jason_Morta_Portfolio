   ...
   <div class="div-cont">
      ...
      <div class="contentContainer" id="stacks">
         ...
         <div class="skill-card">
            ...
            <p>JQUERY: This library makes adding animation with JS much easier and faster. Because of its support on all modern browsers I tend to use jQuery more often.</p>
         </div>
         <div class="skill-card">
            <img src="./img/boots.svg" alt="html5img">
            <p>BOOTSTRAP: To quickly create responsive tables, images, or forms, I turn to bootstrap but add my own styling to give my code a personal touch.</p>
         </div>
