...
export default [
   {
      id: 'js',
      skill_img: './img/html5.svg',
      description: `<em>HTML5</em>: Everyday I'm learning more and better ways to use HTML elements. Writing much cleaner
      and reusable code.`
   },
   {
      id: 'js',
      skill_img: './img/CSS.svg',
      description: `<em>CSS3</em>: I use CSS in every project, even the small ones. I'm familiar with Flex Box, Grid and
      also make use of Bootstrap when needed.`
   },
   {
      id: 'js',
      skill_img: '../img/JS.svg',
   ...
   {
      id: 'js',
      skill_img: './img/jquery-official.svg',
